...
import {Profile, SharedLayout, Calculator, Consultation,Notification, Return, Salary, Investment, Business, HouseProperty, Files, AllHouse } from './pages/dashboard'
    ...
    <Router>
      <Routes>
        ...
        <Route path="/"  element={
          ...
          <Route path='report' element={<Return />}></Route>
